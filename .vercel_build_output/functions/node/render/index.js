...
// .svelte-kit/output/server/chunks/index-75d96579.js
function noop2() {
}
function run(fn) {
  return fn();
...
// .svelte-kit/output/server/chunks/hooks-ff4815b6.js
var hooks_ff4815b6_exports = {};
__export(hooks_ff4815b6_exports, {
  handle: () => handle
});
var cookie, handle;
var init_hooks_ff4815b6 = __esm({
  ".svelte-kit/output/server/chunks/hooks-ff4815b6.js"() {
  ...
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
	...
	<nav class="${"svelte-t2wq17"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-t2wq17"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-t2wq17"}"></path></svg>
		<ul class="${"svelte-t2wq17"}"><li class="${["svelte-t2wq17", $page.url.pathname === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-t2wq17"}">Home</a></li>
			...
			<li class="${["svelte-t2wq17", $page.url.pathname === "/continents" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/continents"}" class="${"svelte-t2wq17"}">Continents</a></li>
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    index = 0;
    entry = "pages/__layout.svelte-6902b1ce.js";
    js = ["pages/__layout.svelte-6902b1ce.js", "chunks/index-cffa86d9.js"];
    css2 = ["assets/pages/__layout.svelte-cf45d713.css"];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    index2 = 1;
    entry2 = "error.svelte-e959684f.js";
    js2 = ["error.svelte-e959684f.js", "chunks/index-cffa86d9.js"];
    css3 = [];
  }
});

// .svelte-kit/output/server/entries/endpoints/continents/continentsData.js
var continentsData_exports = {};
__export(continentsData_exports, {
  continents: () => continents
});
var continents;
var init_continentsData = __esm({
  ".svelte-kit/output/server/entries/endpoints/continents/continentsData.js"() {
    continents = [
      {
        id: "0",
        ...
        mapurl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Africa_%28orthographic_projection%29.svg/1024px-Africa_%28orthographic_projection%29.svg.png"
      },
      {
        id: "1",
        name: "Antartica",
        population: "4,500",
        desc: "Antartica is Earth's southernmost continent. It contains the geographic South Pole and is situated in the Antarctic region of the Southern Hemisphere, almost entirely south of the Antarctic Circle, and is surrounded by the Southern Ocean. At 14,200,000 square kilometres (5,500,000 square miles), it is the fifth-largest continent and nearly twice the size of Australia.",
        learnurl: "https://en.wikipedia.org/wiki/Antartica",
        mapurl: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Antarctica_%28orthographic_projection%29.svg/240px-Antarctica_%28orthographic_projection%29.svg.png"
      },
      {
        id: "2",
        name: "Asia",
        ...
        mapurl: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/80/Asia_%28orthographic_projection%29.svg/1024px-Asia_%28orthographic_projection%29.svg.png"
      },
      {
        id: "3",
        name: "Australia",
        population: "26 million",
        desc: "Australia, officially known as the Commonwealth of Australia, is a sovereign country comprising the mainland of the Australian continent, the island of Tasmania, and numerous smaller islands.[13] It is the largest country in Oceania and the world's sixth-largest country by total area. The population of 26 million[7] is highly urbanised and heavily concentrated on the eastern seaboard.[14] Australia's capital is Canberra, and its largest city is Sydney.",
        learnurl: "https://en.wikipedia.org/wiki/Australia",
        mapurl: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Australia_with_AAT_%28orthographic_projection%29.svg/1024px-Australia_with_AAT_%28orthographic_projection%29.svg.png"
      },
      {
        id: "4",
        name: "Europe",
        population: "748.5 million",
        desc: "Europe is a continent located entirely in the Northern Hemisphere and mostly in the Eastern Hemisphere. It comprises the westernmost part of Eurasia and is bordered by the Arctic Ocean to the north, the Atlantic Ocean to the west, the Mediterranean Sea to the south, and Asia to the east. Europe is commonly considered to be separated from Asia by the watershed of the Ural Mountains, the Ural River, the Caspian Sea, the Greater Caucasus, the Black Sea, and the waterways of the Turkish Straits.",
        learnurl: "https://en.wikipedia.org/wiki/Europe",
        mapurl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Europe_orthographic_Caucasus_Urals_boundary_%28with_borders%29.svg/1024px-Europe_orthographic_Caucasus_Urals_boundary_%28with_borders%29.svg.png"
      },
      {
        id: "5",
        name: "North America",
        population: "373 million",
        desc: "North America is a continent entirely within the Northern Hemisphere and almost all within the Western Hemisphere. It can also be described as a northern subcontinent of the Americas, or America, in models that use fewer than seven continents.",
        learnurl: "https://en.wikipedia.org/wiki/North_America",
        mapurl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/43/Location_North_America.svg/1024px-Location_North_America.svg.png"
      },
      {
        id: "6",
        name: "South America",
        population: "437.5 million",
        desc: "South America is a continent in the Western Hemisphere, mostly in the Southern Hemisphere, with a relatively small portion in the Northern Hemisphere. It can also be described as a southern subcontinent of the Americas. The reference to South America instead of other regions (like Latin America or the Southern Cone) has increased in the last decades due to changing geopolitical dynamics (in particular, the rise of Brazil).",
        learnurl: "https://en.wikipedia.org/wiki/South_America",
        mapurl: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0f/South_America_%28orthographic_projection%29.svg/1024px-South_America_%28orthographic_projection%29.svg.png"
      }
    ];
  }
});

// .svelte-kit/output/server/chunks/index-4c276ab7.js
...
// .svelte-kit/output/server/entries/pages/continents/index.svelte.js
var index_svelte_exports = {};
__export(index_svelte_exports, {
  default: () => Continents
});
var Body2, css4, IconBase, MdKeyboardArrowUp, Item, Accordion, Continents;
var init_index_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/continents/index.svelte.js"() {
    ...
    Body2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let $activeStore, $$unsubscribe_activeStore;
      let { active = "-1" } = $$props;
      const activeStore = writable2(active);
      $$unsubscribe_activeStore = subscribe(activeStore, (value) => $activeStore = value);
    ...
    MdKeyboardArrowUp = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${validate_component(IconBase, "IconBase").$$render($$result, Object.assign({ viewBox: "0 0 24 24" }, $$props), {}, {
        default: () => {
          return `<path d="${"M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6-6 6z"}"></path>`;
        }
      })}`;
    });
    Item = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$unsubscribe_active();
      return `<div class="${"border-gray-100 border-2 rounded-sm m-10 "}"><button class="${[
        "flex text-left w-full focus:outline-none items-center p-4",
        "  "
      ].join(" ").trim()}"><div class="${"w-full"}"><div class="${[
        "font-bold text-lg mb-1 transition text-gray-700 ",
        ""
      ].join(" ").trim()}"><span class="${[
        "border-b-2 inline-block border-transparent transition ",
        " "
      ].join(" ").trim()}">${escape(title)}</span></div>
    
            ${!!subTitle ? `<div class="${"text-gray-400 text-sm"}">${escape(subTitle)}</div>` : ``}</div>

        <div class="${[
        "w-8 transform transition text-gray-300 ",
        (isCurrentActive ? "rotate-180" : "") + " "
      ].join(" ").trim()}">${validate_component(MdKeyboardArrowUp, "MdKeyboardArrowUp").$$render($$result, {}, {}, {})}</div></button>

    ${isCurrentActive ? `<div class="${"px-4 pb-4 mt-4 bg-slate-200"}">${slots.default ? slots.default({}) : ``}</div>` : ``}</div>`;
    });
    Accordion = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      do {
        $$settled = true;
        $$rendered = `${validate_component(Body2, "Body").$$render($$result, { active }, {
          active: ($$value) => {
            active = $$value;
            $$settled = false;
          }
          ...
          default: () => {
            return `${validate_component(Item, "Item").$$render($$result, { id, title, subTitle }, {}, {
              default: () => {
                return `<h3>${escape(content)}</h3>`;
              }
            })}`;
          }
        })}`;
    ...
    Continents = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let active = "-1";
      let $$settled;
      let $$rendered;
      do {
        $$settled = true;
        $$rendered = `${$$result.head += `${$$result.title = `<title>Continents</title>`, ""}<meta name="${"description"}" content="${"An accordion component using Svelte and Tailwind"}" data-svelte="svelte-fbxemy">`, ""}

<div class="${"border-gray-200 border-4 rounded-sm "}"><h1>Continents</h1>
	
	<div class="${"space-y-4"}"><button class="${"px-4 py-2 w-full block bg-blue-400 text-white"}">Click to keep single/multiple item(s) open
			</button>
		
		${each(continents, ({ id, name, population, desc }) => {
          return `${``}
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    init_index_svelte();
    index3 = 3;
    entry3 = "pages/continents/index.svelte-ff8f23f3.js";
    js3 = ["pages/continents/index.svelte-ff8f23f3.js", "chunks/index-cffa86d9.js", "chunks/index-164bb370.js", "chunks/index-8a73ca44.js"];
    css5 = ["assets/pages/continents/index.svelte-cd06621c.css"];
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    init_index_svelte2();
    index4 = 5;
    entry4 = "pages/todos/index.svelte-128f9b8b.js";
    js4 = ["pages/todos/index.svelte-128f9b8b.js", "chunks/index-cffa86d9.js", "chunks/singletons-d1fb5791.js", "chunks/index-8a73ca44.js"];
...
var Server = class {
  ...
  async respond(request, options = {}) {
    ...
    if (!this.options.hooks) {
      const module2 = await Promise.resolve().then(() => (init_hooks_ff4815b6(), hooks_ff4815b6_exports));
      this.options.hooks = {
...
var manifest = {
  ...
  _: {
    entry: { "file": "start-9801657a.js", "js": ["start-9801657a.js", "chunks/index-cffa86d9.js", "chunks/index-164bb370.js", "chunks/singletons-d1fb5791.js"], "css": [] },
    nodes: [
    ...
    routes: [
      ...
      {
        type: "endpoint",
        id: "continents/continentsData",
        pattern: /^\/continents\/continentsData\/?$/,
        names: [],
        types: [],
        load: () => Promise.resolve().then(() => (init_continentsData(), continentsData_exports))
      }
    ],
    matchers: async () => {
      return {};
